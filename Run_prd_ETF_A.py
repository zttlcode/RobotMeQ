...
def run_live(assetList):
    ...
    for asset in assetList:
        if asset.positionEntity.trade_point_list:  # 不为空，则保存
            ...
            df_tpl.to_csv(RMTTools.read_config("RMQData", "trade_point_live_tea_conservative")
                          + asset.assetsMarket
                          + "_"
    ...
    processes = [Process(target=run_live,
                 ...
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('510300',
                                                        ...
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('510500',
                                                        '中证500指数',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('512100',
                                                        '中证1000指数',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 ...
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('515030',
                                                        ...
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('513050',
                                                        '中概互联',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        0, 'A'),)),
                 ...
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('159611',
                                                        ...
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('512200',
                                                        '地产',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 ...
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('512800',
                                                        ...
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('512980',
                                                        '传媒',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('512880',
                                                        '证券',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 ...
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('515880',
                                                        ...
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('516150',
                                                        '稀土',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
                 Process(target=run_live,
                         args=(RMQAsset.asset_generator('516110',
                                                        '汽车',
                                                        ['5', '15', '30', '60', 'd'],
                                                        'ETF',
                                                        1, 'A'),)),
